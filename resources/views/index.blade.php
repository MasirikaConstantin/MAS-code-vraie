...
<section class="pt-4 linear-g-w-2" >
  ...
  .bi {
    ...
    <div class="d-flex flex-column flex-md-row" >
      ...
      <h1 class="text-4xl font-bold dark:text-white mb-4" ><i class="bi bi-patch-question"></i> Les Astuces récentes</h1>
...
<div class="container mx-auto px-4">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      ...
      <div class="container mx-auto" >
        ...
        <a href="{{route('astuces')}}"  class="text-gray-900 mt-5 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2">
        ...
        <a href="{{route('astuces.new')}}" class="text-gray-900 mt-5 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2">
    ...
    <div class="container mx-auto px-4" >
      ...
      <h1 class="text-4xl font-bold dark:text-white mb-4" ><i class="bi bi-patch-question"></i> Les Questions récentes</h1>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="d-sm-block" >
        ...
        <a href="{{route('user.accueil')}}"  class="text-gray-900 mt-5 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2">
          <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-width="2" d="M21 12c0 1.2-4.03 6-9 6s-9-4.8-9-6c0-1.2 4.03-6 9-6s9 4.8 9 6Z"/>
            <path stroke="currentColor" stroke-width="2" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
          </svg>
        ...
        <a href="{{route('user.newpost')}}" class="text-gray-900 mt-5 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2">
  ...
  <section class="container mx-auto"  >
    ...
    <div class="container" >
      ...
      <h1 class="text-4xl font-bold dark:text-white mb-4" > <i class="bi bi-sliders"></i> Nos sujets</h1>

      @foreach ($categories as $category )
        <a type="button" href="{{route('tous',['category_id' => $category->id])}}" title="{{$category->titre}}" data-bs-content="{{$category->description}}" data-bs-placement="top" data-bs-trigger="hover" class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2">
