<div>
    ...
    <form class="mt-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="relative">
                <input type="text" wire:model.debounce.300ms="titre"
            ...
            <div class="relative">
                <input type="text" wire:model.debounce.300ms="contenus"
                       class="w-full h-12 bg-gray-800/50 rounded-lg border border-gray-700 text-white pl-4 pr-10 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/30 transition-all"
            ...
            <button type="button" wire:click="resetFilters"
                    class="h-12 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:shadow-lg hover:shadow-purple-500/25 transform hover:scale-105 transition-all">
                Réinitialiser
            </button>
        </div>
    </form>
