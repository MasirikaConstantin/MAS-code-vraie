  ...
  <div class="max-w-4xl mx-auto px-4">
    <form action="{{route($category->exists ? 'admin.editcat': 'admin.newcat', $category)}}" method="post" enctype="multipart/form-data" class="space-y-6 bg-gray-800 p-8 rounded-2xl shadow-xl backdrop-blur-lg border border-gray-700">
      ...
      <div>
        ...
        <input type="text" name="svg" value="{{ old('svg',$category->svg)}}" class="w-full bg-gray-700 border-2 border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-blue-500 transition duration-200">
      </div>
