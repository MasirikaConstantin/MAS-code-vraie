...
<main class="flex-shrink-0 mt-6 ">
      ...
      <div class="mt-6" style="margin-top: 90px" >
        <h1 class="text-4xl font-bold dark:text-white mt-6 mb-4">@yield('section','')   </h1>
      </div>
      ...
      <div id="successAlert" class="flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
        ...
        <div>
          ...
          <button type="button" onclick="this.parentElement.remove()" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">X</button>
        </div>
      </div>
