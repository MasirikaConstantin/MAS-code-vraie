                              ...
                              <button id="multiLevelDropdownButton" data-dropdown-toggle="multi-dropdown" class="w-full bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-all duration-300 flex items-center justify-between" type="button">Action<svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                ...
                                <div id="multi-dropdown" class="z-10 hidden dropdown-menu hidden absolute w-full mt-2 bg-gray-700 rounded-lg shadow-xl">
                                  <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="multiLevelDropdownButton">
                                    <li>
                                    <a href="{{route('astuces.new')}}" class="block px-4 py-2 hover:bg-gray-600 text-gray-300 hover:text-white">Astuce</a>
                                    </li>
                                    <li>
                                    <a href="{{route('user.newpost')}}" class="block px-4 py-2 hover:bg-gray-600 text-gray-300 hover:text-white">Post</a>
            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl p-6 backdrop-blur-lg border border-indigo-500/20">
                    ...
                    <div class="flex space-x-4 mb-6">
                        <a href="?demande" class="tab-futuristic {{ !request('demande') ? 'text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800' : 'font-medium text-blue-600 dark:text-blue-500 hover:underline' }}">
                            Brouillon
                        </a>
                        <a href="?demande=q" class="tab-futuristic {{ request('demande') == 'q' ? 'text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800' : 'font-medium text-blue-600 dark:text-blue-500 hover:underline' }}">
                            Mes Questions
                        </a>
                        <a href="?demande=a" class="tab-futuristic {{ request('demande') == 'a' ? 'text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800' : 'font-medium text-blue-600 dark:text-blue-500 hover:underline' }}">
                            Mes Astuces
                        </a>
                    </div>
