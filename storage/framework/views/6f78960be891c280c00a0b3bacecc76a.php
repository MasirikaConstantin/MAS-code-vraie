...
<html lang="en" class="h-100" data-bs-theme="auto">
  <head><script src="<?php echo e(asset('color-modes.js')); ?>"></script>
    ...
    <title><?php echo $__env->yieldContent('titre' ,'Blog'); ?></title>
...
<link rel="shortcut icon" href="<?php echo e(asset('grace2.ico')); ?>" type="image/x-icon">
            ...
            <p class="mb-2 text-secondary fw-bold"><i class="bi bi-info-circle"></i> A propos</p>
                ...
                <div class="modal-dialog  modal-dialog-scrollable">
                    ...
                    <div class="modal-body ">
                        ...
                        <a href="<?php echo e(route('login')); ?>"><strong>Rejoignez-nous ! :</strong></a>
...
<?php /**PATH /home/mascodep/public_html/blog.mascodeproduct.com/site/resources/views/baseentete.blade.php ENDPATH**/ ?>